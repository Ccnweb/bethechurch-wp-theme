...
function ccnbtc_custom_post_type_inscriptions() {
    ...
    $fields = array(
        ...
        array('id' => $prefix.'_key_indiv_elle', 'copy' => $prefix.'_key_indiv'), // une copie de Nom prénom pour "Elle"
        array('id' => $prefix.'_key_indiv_lui', 'copy' => $prefix.'_key_indiv'), // une copie de Nom prénom pour "Lui"
        array( // Homme/Femme
        ...
        array( // Logement remarques
            'id' => $prefix.'key_logement_remarques',
            'type' => 'textarea',
            'required' => false,
